...
function Footer() {
    return (
        <div className='bg-[#1c303a] w-full flex flex-col relative'>
            ...
            <div className='w-full flex flex-col lg:flex-row justify-start pl-5 lg:px-0 lg:pl-48 gap-10 lg:gap-36 z-10'>
                <div className='flex justify-between lg:flex-col gap-1 lg:justify-start text-sm font-semibold'>
                    <h1 className='font-semibold text-lg'>Navigation</h1>
                    <div className='flex flex-col gap-2 pr-20 lg:pr-0'>
                ...
                <div className='flex justify-between lg:flex-col gap-1 lg:justify-start text-sm font-semibold'>
                    ...
                    <div className='flex flex-col gap-2 pr-28 lg:pr-0'>
            ...
            <hr className='mb-6 mt-6 mx-5 lg:mx-48 border-gray-500' />
            <div className='mb-10 mx-5 lg:mx-48 flex flex-col lg:flex-row items-center justify-between'>
                <h1 className='text-xl font-italic font-light flex flex-col lg:flex-row items-center gap-2'>SONY PICTURES <span className='text-sm flex items-center gap-2'><Copyright strokeWidth={1} size={15} />Crunchyrolls , LLC</span></h1>
                <h1 className='font-semibold flex items-center gap-1 mt-5 lg:mt-0'><ChevronDown strokeWidth={3} fill='gray' color />ENGLISH (US)</h1>
            </div>
        </div>
    )
}
